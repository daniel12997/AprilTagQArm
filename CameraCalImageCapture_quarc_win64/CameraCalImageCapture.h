...
typedef struct {
  ...
  real_T grippercurrent;               /* '<S9>/HIL Read Timebase1' */
  real_T RateLimiter;                  /* '<Root>/Rate Limiter' */
  real_T gripposition;                 /* '<S7>/Switch' */
  real_T x0;                           /* '<S10>/x0' */
  real_T Integrator1;                  /* '<S10>/Integrator1' */
  real_T goalcurrent;                  /* '<S7>/Soft-Grip Current (A)' */
  ...
  real32_T In1[9];                     /* '<S4>/In1' */
  uint8_T VirtualQArmRGB_o1[307200];   /* '<Root>/Virtual QArm RGB' */
  uint8_T In1_g[307200];               /* '<S3>/In1' */
  uint8_T c_I[307200];
  boolean_T foranyofthejoints;         /* '<S9>/for any of the joints' */
} B_CameraCalImageCapture_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILReadTimebase1_AnalogBuffer[5];/* '<S9>/HIL Read Timebase1' */
  real_T HILReadTimebase1_OtherBuffer[20];/* '<S9>/HIL Read Timebase1' */
  real_T PrevY;                        /* '<Root>/Rate Limiter' */
  real_T Memory_PreviousInput;         /* '<Root>/Memory' */
  real_T HILWrite_OtherBuffer[13];     /* '<S8>/HIL Write' */
  ...
  t_task HILReadTimebase1_Task;        /* '<S9>/HIL Read Timebase1' */
  struct {
    real_T Amp;
    real_T W;
    real_T Sin_w_dt;
    ...
    real_T Sin_w_t;
    real_T Cos_w_t;
  } SmoothSignalGenerator_RWORK;       /* '<S8>/Smooth Signal Generator' */

  struct {
    void *LoggedData[2];
  } CurrentFilteration_PWORK;          /* '<S7>/Current Filteration' */

  struct {
    void *LoggedData[2];
  } GoalvsActualGripCurrent_PWORK;     /* '<S7>/Goal vs. Actual Grip Current' */

  void *HILSetProperty_PWORK[2];       /* '<S2>/HIL Set Property' */
  void *DisplayImage_PWORK;            /* '<Root>/Display Image' */
  ...
  int_T DisplayImage_IWORK;            /* '<Root>/Display Image' */
...
struct P_CameraCalImageCapture_T_ {
  ...
  real_T undOrder25HzfilterbasedonFFT__n;
                               ...
                               */
  int32_T DisplayImage_update_rate;  /* Mask Parameter: DisplayImage_update_rate
  ...
  boolean_T Video3DInitialize_active;/* Mask Parameter: Video3DInitialize_active
                                      ...
                                      */
  boolean_T DisplayImage_orig_size;    /* Mask Parameter: DisplayImage_orig_size
                                        * Referenced by: '<Root>/Display Image'
                                        */
  ...
  int32_T HILSetProperty_PropertyCodes[4];
                              ...
                              */
  real32_T image_Y0;                   /* Computed Parameter: image_Y0
  ...
  boolean_T HILSetProperty_Active;  /* Computed Parameter: HILSetProperty_Active
                                     * Referenced by: '<S2>/HIL Set Property'
                                     */
  uint8_T image_Y0_m;                  /* Computed Parameter: image_Y0_m
 ...
 * '<S3>'   : 'CameraCalImageCapture/If Action Subsystem'
 * '<S4>'   : 'CameraCalImageCapture/If Action Subsystem1'
 * '<S5>'   : 'CameraCalImageCapture/MATLAB Function'
 * '<S6>'   : 'CameraCalImageCapture/Hardware Plant P(s)/Compare To Constant'
 * '<S7>'   : 'CameraCalImageCapture/Hardware Plant P(s)/Gripper Control'
 * '<S8>'   : 'CameraCalImageCapture/Hardware Plant P(s)/Subsystem'
 * '<S9>'   : 'CameraCalImageCapture/Hardware Plant P(s)/Subsystem1'
 * '<S10>'  : 'CameraCalImageCapture/Hardware Plant P(s)/Gripper Control/2nd Order 25Hz filter (based on FFT)'
 * '<S11>'  : 'CameraCalImageCapture/Hardware Plant P(s)/Subsystem1/Stop with Message'
 * '<S12>'  : 'CameraCalImageCapture/Hardware Plant P(s)/Subsystem1/is greater than 90 deg//s'
 * '<S13>'  : 'CameraCalImageCapture/Hardware Plant P(s)/Subsystem1/Stop with Message/Compare'
 */
