...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&CameraCalImageCapture_B.grippercurrent), 0, 0, 11 },

  { (char_T *)(&CameraCalImageCapture_B.VirtualQArmRGB_o5[0]), 1, 0, 18 },

  { (char_T *)(&CameraCalImageCapture_B.VirtualQArmRGB_o1[0]), 3, 0, 614400 },
  ...
  { (char_T *)(&CameraCalImageCapture_DW.Integrator1_IWORK), 10, 0, 2 },

  { (char_T *)(&CameraCalImageCapture_DW.If_ActiveSubsystem), 2, 0, 5 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&CameraCalImageCapture_P.DisplayImage_update_rate), 6, 0, 1 },

  { (char_T *)(&CameraCalImageCapture_P.HILWrite_other_channels[0]), 7, 0, 14 },

  { (char_T *)(&CameraCalImageCapture_P.Video3DInitialize_active), 8, 0, 2 },
  ...
  { (char_T *)(&CameraCalImageCapture_P.image_Y0), 1, 0, 1 },
  ...
  { (char_T *)(&CameraCalImageCapture_P.image_Y0_m), 3, 0, 2 }
};
