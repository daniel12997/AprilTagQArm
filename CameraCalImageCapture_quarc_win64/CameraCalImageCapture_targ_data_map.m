    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_P.DisplayImage_update_rate
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_P.DisplayImage_orig_size
            ...
            section.data(48)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_P.Switch_Threshold_i
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_P.image_Y0
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_P.image_Y0_m
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_B.VirtualQArmRGB_o5
                    section.data(1).logicalSrcIdx = 12;
                    section.data(1).dtTransOffset = 0;

                    ;% CameraCalImageCapture_B.In1
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_DW.DisplayImage_PWORK
                    section.data(4).logicalSrcIdx = 14;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_DW.DisplayImage_IWORK
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% CameraCalImageCapture_DW.If_ActiveSubsystem
                    section.data(1).logicalSrcIdx = 23;
                    section.data(1).dtTransOffset = 0;

                    ;% CameraCalImageCapture_DW.If1_ActiveSubsystem
    ...
    targMap.checksum0 = 2412154689;
    targMap.checksum1 = 3137354760;
    targMap.checksum2 = 1554175097;
    targMap.checksum3 = 3572230178;
